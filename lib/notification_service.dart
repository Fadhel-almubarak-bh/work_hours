...
class NotificationService {
  ...
  static Future<void> _scheduleWorkDayNotifications({
    ...
    for (int dayIndex = 0; dayIndex < 7; dayIndex++) {
      if (workDays[dayIndex]) {
        ...
        final tz.TZDateTime nextOccurrence = _getNextOccurrenceOfDay(dayIndex, hour, minute);
        debugPrint('Next occurrence for ${_getDayName(dayIndex)}: $nextOccurrence');
        ...
        debugPrint('Scheduled $title for ${_getDayName(dayIndex)} at $hour:$minute (ID: $notificationId)');
      }
    }
  }
  
  static tz.TZDateTime _getNextOccurrenceOfDay(int dayIndex, int hour, int minute) {
  ...
  static String _getDayName(int dayIndex) {
    ...
    switch (dayIndex) {
      case 0: return 'Monday'; // DateTime.monday == 1
      case 1: return 'Tuesday';
      case 2: return 'Wednesday';
      case 3: return 'Thursday';
      case 4: return 'Friday';
      case 5: return 'Saturday';
      case 6: return 'Sunday'; // DateTime.sunday == 7
