...
class _WorkHoursScreenState extends State<WorkHoursScreen> with AutomaticKeepAliveClientMixin {
  ...
  void _getTodayStatus() {
    ...
    final data = controller.getTodayStatus();
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: (clockInTime == null || (clockInTime != null && clockOutTime != null)) ? _handleClockIn : null,
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: (clockInTime != null && clockOutTime == null) ? _handleClockOut : null,
